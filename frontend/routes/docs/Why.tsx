  ...
  return (
    <>
      ...
      <section style={styles.section}>
        <p style={styles.text}>
          I built this app for myself to be a quick starter app that would be
          scalable for 90% of my projects. The learnings come from working on
          full stack JS/TS apps for the last ~10 years.
        </p>
      </section>
